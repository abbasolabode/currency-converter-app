...
const Button = ({handleSwitchCurrency}) => {
  ...
  return (
		<div className='w-[22.5rem] min-h-[4rem] flex justify-center  gap-5 mt-[4rem] laptop:mx-auto'>
			...
			<button  onClick={handleSwitchCurrency} className='w-[4.2rem] min-h-[4.2rem] rounded-full shadow-2xl bg-sky-500 text-white font-bold hover:bg-sky-300 hover:transition-all hover:scale-95'  type="button">Switch</button>
		</div>
	);
}
